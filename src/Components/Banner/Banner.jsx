...
const Banner = () => {
    return (
        <div className='w-full md:h-[600px]  px-10 md:flex md:items-center'>
            <div className='md:w-1/2 w-full md:py-20 pt-10 space-y-7'>
                <h1 className='md:text-6xl text-3xl font-bold'>Join <span className='text-green-700'>Volunteer Wave</span> <br /> and Create a <br /> Positive Impact!</h1>
